...
contract ERC165 is Ownable {
    ...
    // calling it 'whenPaused' instead of 'paused' because Open Zeppelin already defines an 'paused' modifier
    modifier whenPaused() {
        require(_paused, "contract is not paused");
        _;
    }

    function pause(bool p) public onlyOwner {
        _paused = p;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=owner(), "address must not be contract owner");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((msg.sender==owner())||isApprovedForAll(owner(),to), "caller is not contract owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId]==from,"'from' address must be token owner");
...
contract CapstoneMG is ERC721Metadata {

    constructor() ERC721Metadata("CapstoneMG", "CMG", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {
    }
